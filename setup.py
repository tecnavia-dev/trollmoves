...
setup(name="trollmoves",
      ...
      data_files=[('config_files/met11',['trollmoves_server-met11.cfg','trollmoves_client-met11.cfg']),('other/eumetsat',['xRITDecompress']),('other/eumetsat',['xRITDecompress64']),('etc',['trollstart/pytroll_funcs.sh','trollstart/pytroll_start.sh'])],
      packages=['trollmoves'],
      zip_safe=False,
