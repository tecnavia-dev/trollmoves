...
setup(name="trollmoves",
      ...
      data_files=[('config_files/met11',['trollmoves_server-met11.cfg','trollmoves_client-met11.cfg']),
                  ('config_files/foreign',['trollmoves_server-foreign.cfg','trollmoves_client-foreign.cfg']),
